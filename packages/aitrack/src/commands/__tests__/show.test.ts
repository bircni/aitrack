...
vi.mock('aitrack-lib/data/localData', () => ({
...
vi.mock('aitrack-lib/readers/cursor/index', () => ({ readCursorData: mocks.readCursorData }));
vi.mock('aitrack-lib/display/renderPng', () => ({ renderToPng: mocks.renderToPng }));
